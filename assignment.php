	...
	<body>
		...
		<div id="myCarousel" class="carousel slide carousel-slide" data-bs-interval="false">
			...
			<div class="controls-top align-middle text-center bg-light p-3">
				...
				<a class="btn-floating btn-secondry p-2 featured_text" href="#myCarousel" data-bs-slide-to="0" style="background: none 0% 0% repeat scroll rgb(14,23,49);color: rgb(255, 255,255);">Create Assignment</a>
                <a class="btn-floating btn-secondry p-2 featured_text" href="#myCarousel" data-bs-slide-to="1" style="background: none 0% 0% repeat scroll rgb(14,23,49);color: rgb(255, 255,255);">View all assignments</a>
							...
							if(mysqli_connect_error()){
								...
								if($mentor){
									...
									while($row=mysqli_fetch_assoc($assigned)){
										...
										echo '</div><hr>';
										if(isset($row['qfile'])){
										echo '<a href="questions/'.$row['qfile'].'" target="_blank" class="mb-1 file d-inline-flex align-items-center">';//open the file
										...
										echo $row['ques'];
										echo '</div>';
										echo '<small>'.$mrow['name'].'    '.$row['posted'].'</small>';
										echo '</button>';
									}
								}else{
									die(mysqli_error());
