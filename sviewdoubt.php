	...
	<body>
		...
		<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasL" aria-labelledby="offcanvasLabel">
		  ...
		  <div class="offcanvas-body text-center mt-5">
			...
			<li class="mb-3"><a href="mydoubts.php">All doubts</a></li>
			</h5>
			</ul>
		  </div>
		</div>
		...
		<div class="main d-flex m-3">
			...
			<?php
				...
				if(is_null($row['answer'])){
					echo '<div class="ms-auto">Not Answered</div>';
				}else{
			...
			<div class="card text-center">
			  <div class="card-body">
				<?php
					echo '<h5 class="card-title">Reply</h5>';
					echo $mrow['name'];
					if(!is_null($row['answer'])){
						echo '<div class="card-text mt-2">'.nl2br($row['answer']).'</div>';
					}
				?>
			  </div>
			</div>
