...
<html lang="en">
	...
	<body>    
		...
		<form action="menpassword.php" method="post">  
			<div class="container">   
				<div class="mb-3">
				...
				<button onclick="location.href='menviewprofile.php'" type="button" class="btn btn-danger">Cancel</button>   
				</div>
			</div>   
		</form>     
